...
Le rôle de l'assurance est d'apporter une sécurité face aux dangers de la vie. Dans le contexte socio-économique actuel, l'être humain redoute la survenance de divers évènements comme : la panne de voiture, la coupure d'électricité, l'incendie domestique, le décès d'un proche, etc. Ces événements dont le caractère est aléatoire et redouté sont appelés risques. Dans le langage des assurances, un risque qui se réalise est appelé sinistre.

Pour se protéger d'un risque, une personne peut souscrire un contrat d'assurance auprès d'une compagnie d'assurance, appelé assureur. Dès lors, la compagnie s'engage à verser une prestation (somme d'argent souvent) à l'assuré s'il est victime d'un sinistre. En contrepartie du service, l'assuré (souscripteur ou adhérent plus exactement) verse une prime à l'assureur.

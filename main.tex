...
\begin{itemize}
    \item d'un prélèvement forfaitaire ou progressif en fonction des revenus (cf annexe \ref{appendix:fiscalite-vie}) ;
    \item des prélèvements sociaux au taux de 17,2\%.
\end{itemize}
